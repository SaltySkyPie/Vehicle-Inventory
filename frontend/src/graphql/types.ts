...
export function useGetVehiclesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetVehiclesQuery, GetVehiclesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetVehiclesQuery, GetVehiclesQueryVariables>(GetVehiclesDocument, options)
}
export function useGetVehiclesSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<GetVehiclesQuery, GetVehiclesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useGetVehicleLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetVehicleQuery, GetVehicleQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetVehicleQuery, GetVehicleQueryVariables>(GetVehicleDocument, options)
}
export function useGetVehicleSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<GetVehicleQuery, GetVehicleQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useRemoveVehicleMutation(
  baseOptions?: Apollo.MutationHookOptions<RemoveVehicleMutation, RemoveVehicleMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useAddImagesMutation(
  baseOptions?: Apollo.MutationHookOptions<AddImagesMutation, AddImagesMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useRemoveImageMutation(
  baseOptions?: Apollo.MutationHookOptions<RemoveImageMutation, RemoveImageMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
